...
| 7 | `phase-7.md` | P7-A → P7-N, P7.5-A → P7.5-J (24) | Active (7.5) |
...
**Current session: 7.5** — manifests in `phase-7.md`, search for `### P7.5-{letter}`.

| Batch | Session | Phase File |
|-------|---------|------------|
| P7.5-A | 7.5 | `phase-7.md` |
| P7.5-B | 7.5 | `phase-7.md` |
| P7.5-C | 7.5 | `phase-7.md` |
| P7.5-D.0–D.9 | 7.5 | `phase-7.md` |
| P7.5-E.0–E.3 | 7.5 | `phase-7.md` |
| P7.5-F | 7.5 | `phase-7.md` |
| P7.5-G | 7.5 | `phase-7.md` |
| P7.5-H | 7.5 | `phase-7.md` |
| P7.5-I | 7.5 | `phase-7.md` |
| P7.5-J | 7.5 | `phase-7.md` |
